...
func NewDefaultMilestoneService(logger *zap.Logger, db *gorm.DB) idl.MilestoneService {
	return &defaultMilestoneService{defaultMilestoneTask: newDefaultMilestoneTask(logger, db)}
}
